...
class MainReaperDecider(ReaperDecider):
    def decide(
        ...
        if not on_mission:
            decision_output = self.get_new_decision(
        ...
        if actual_target_grid_unit_state:
            ...
            reaper_game_state.current_target_info.player_id = actual_target_grid_unit_state.unit.player
        ...
        if target_availability == TargetAvailabilityState.invalid:
            ...
            new_decision = self.get_new_decision(
                game_grid_information,
                player_state,
                reaper_game_state,
                reaper_q_state,
    ...
    def get_new_decision(
        ...
        reaper_game_state.current_target_info.player_id = target_grid_unit_state.unit.player
